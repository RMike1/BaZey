                    ...
                    <div class="col-md-6 col-lg-6 col-xl-12">
                        <div class="card bg-primary">
                            <div class="card-body row">
                                ...
                                <div class="col">
                                    <img class="img-fluid" src="/admin/dist/assets/images/interview.svg" alt="interview">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="flex-grow-1">
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar2.jpg" alt="profile">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar9.jpg" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar12.jpg" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar8.jpg" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar7.jpg" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                ...
                                <div class="py-2 d-flex align-items-center border-bottom flex-wrap">
                                    <div class="d-flex align-items-center flex-fill">
                                        <img class="avatar lg rounded-circle img-thumbnail" src="/admin/dist/assets/images/lg/avatar3.jpg" alt="profile">
                                        <div class="d-flex flex-column ps-3">
                                    ...
                                    <div class="col">
                                        <div class="card shadow">
                                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                                <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="profile/uploads/{{$item->image}}" onerror="this.src='{{asset('images/image.PNG')}}'" alt="profile">
                                                <h6 class="fw-bold my-2 small-14">{{$item->name}}</h6>
                                                <span class="text-muted mb-2">{{$item->email}}</span>
                                                <span class="text-muted mb-2">{{$item->phone}}</span>
                                                <h4 class="fw-bold text-primary fs-3"></h4>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
