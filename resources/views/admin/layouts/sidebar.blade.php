<div class="sidebar px-4 py-4 py-md-5 me-0">
    <div class="d-flex flex-column h-100">
        <a href="index.html" class="mb-0 brand-icon">
            ...
            <span class="logo-text">Bazey</span>
        </a>
        <!-- Menu: main ul -->
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu collapse show" id="dashboard-Components">
                    <li><a class="ms-link active" href="{{url('/')}}"> <span>Admin Dashboard</span></a></li>
                <li><a class="ms-link" href="{{url('dashboard_2')}}"> <span>Dashboard 2</span></a></li>
                </ul>
            </li>
            ...
            <li  class="collapsed">
                <a class="m-link"  data-bs-toggle="collapse" data-bs-target="#project-Components" href="#">
                    <i class="icofont-briefcase"></i><span>Category</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu collapse" id="project-Components">
                    <li><a class="ms-link" href="categories"><span>Categories</span></a></li>
